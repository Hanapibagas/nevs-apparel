...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('barang_masuk_costumer_services', function (Blueprint $table) {
            ...
            $table->foreignId('jenis_kerah_id')->constrained('kera_bajus')->onUpdate('cascade')->onDelete('cascade');
            $table->foreignId('jenis_pola_id')->constrained('pola_lengans')->onUpdate('cascade')->onDelete('cascade');
            $table->foreignId('jenis_celana_id')->constrained('pola_celeanas')->onUpdate('cascade')->onDelete('cascade');
