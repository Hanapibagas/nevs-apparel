        ...
        foreach ($laporans as $laporan) {
            ...
            if ($itemSortir) {
                ...
                if ($itemSortir->lk_player_id) {
                    $penanggung_jawab_id_kertas  = $itemSortir->Kertas ? $itemSortir->Kertas->nama : 'Belum melakukan update data';
                    $penanggung_jawab_id  = $itemSortir->Kain ? $itemSortir->Kain->nama : 'Belum melakukan update data';
                    $laporanDataSortir['player'][] = [
                        ...
                        'kertas_id' => $penanggung_jawab_id_kertas,
                        'cetak_id' => $penanggung_jawab_id,
            ...
            if ($itemManualCut) {
                ...
                if ($itemManualCut->lk_player_id) {
                    $penanggung_jawab_id  = $itemManualCut->Kain ? $itemManualCut->Kain->nama : 'Belum melakukan update data';
            ...
            if ($itemPressKain) {
                ...
                if ($itemPressKain->lk_player_id) {
                    $penanggung_jawab_id  = $itemPressKain->Kain ? $itemPressKain->Kain->nama : 'Belum melakukan update data';
            ...
            if ($item) {
                ...
                if ($item->lk_player_id) {
                    $penanggung_jawab_id  = $item->Kertas ? $item->Kertas->nama : 'Belum melakukan update data';
                    // $tanda_selesai = $item->selesai ? $item->selesai : 'Bbelum melakukann update'
                    $laporanData['player'][] = [
                        'id' => $item->id,
                        'deadline' => $item->deadline,
                        'selesai' => $item->selesai,
                        'kertas_id' => $penanggung_jawab_id,
